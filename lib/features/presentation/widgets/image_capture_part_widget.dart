...
import 'package:ccms/features/presentation/widgets/large_btn.dart';
...
class ImageCapturePartWidget extends ConsumerStatefulWidget {
  const ImageCapturePartWidget({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ImageCapturePartWidgetState();
}

class _ImageCapturePartWidgetState
    extends ConsumerState<ImageCapturePartWidget> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget getDocheading(Document? doc) {
    if (doc != null) {
      return Text(
        'Selected Document : ${doc.toString()}',
      ...
      return const Text(
        ...
        style: TextStyle(
            color: Colors.redAccent, fontSize: 18, fontWeight: FontWeight.w500),
      );
    }
  }
    ...
    return Stack(
      children: [
        Container(
          ...
          child: Column(
            children: [
              const ContainerHeadingWidget(title: 'Image Capture'),
              ...
              child: Row(
                ...
                children: [
                  MainBtn(
                    ...
                    fontcolor: doc == null
                        ? Colors.grey
                        : const Color.fromARGB(255, 243, 232, 83),
                    ontap: doc == null
                        ? null
                        : () async {
                            ...
                            // print(selectedFiles!.files);
                            List<String> files = [];
                            for (PlatformFile file in selectedFiles!.files) {
                              files.add(file.path!);
                            }
                            ref
                                .read(pickedFileListProvider.notifier)
                                .addListOfPath(files);
                          },
                  ),
...
// class ImageCapturePartWidget extends StatefulWidget {
//   /// Default Constructor
//   const ImageCapturePartWidget({super.key});

//   @override
//   State<ImageCapturePartWidget> createState() => _ImageCapturePartWidgetState();
// }

// class _ImageCapturePartWidgetState extends State<ImageCapturePartWidget> {
